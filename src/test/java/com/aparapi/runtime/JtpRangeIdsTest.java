...
public class JtpRangeIdsTest {
    ...
    private class MatrixKernel extends Kernel {
        public boolean passed[] = new boolean[test.length];
        ...
        public void run() {
            ...
            synchronized (test) {
                ...
                if (show) {
                    passed[globalThreadId] = false;
                    System.out.println("derived =>" + globalThreadId + " " + threadId + " " + x + "," + y + " " + lx + "," + ly + " " + w + "," + h);
                    System.out.println("data    =>" + test[globalThreadId][0] + " " + test[globalThreadId][1] + " " + test[globalThreadId][2] + "," + test[globalThreadId][3] + " " + test[globalThreadId][4] + ","  + test[globalThreadId][5] + " " + w + "," + h);
                    System.out.println();
                }
                else
                    passed[globalThreadId] = true;
            }
        }
