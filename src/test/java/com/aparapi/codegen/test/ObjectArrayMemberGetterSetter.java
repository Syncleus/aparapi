...
final class TheOtherOne {
    private static final Logger LOGGER = Logger.getLogger(TheOtherOne.class);
    int mem;
...
public class ObjectArrayMemberGetterSetter extends Kernel {
    private static final Logger LOGGER = Logger.getLogger(ObjectArrayMemberGetterSetter.class);
