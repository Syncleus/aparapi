...
public interface OpenCL<T>{
   ...
   @Retention(RetentionPolicy.RUNTIME) @interface Put{
   }

   public
   @Target(ElementType.PARAMETER)
   @Retention(RetentionPolicy.RUNTIME) @interface Get{
   }

   public
   @Target(ElementType.TYPE)
   @Retention(RetentionPolicy.RUNTIME) @interface Source{
      String value();
   ...
   public
   @Target(ElementType.TYPE)
   @Retention(RetentionPolicy.RUNTIME) @interface Resource{
      String value();
   }

   public
   @Target(ElementType.METHOD)
   @Retention(RetentionPolicy.RUNTIME) @interface Kernel{
      String value();
   }
   ...
   public
   @Target(ElementType.PARAMETER)
   @Retention(RetentionPolicy.RUNTIME) @interface GlobalReadWrite{
      String value();
   }

   public
   @Target(ElementType.PARAMETER)
   @Retention(RetentionPolicy.RUNTIME) @interface GlobalReadOnly{
      String value();
   }

   public
   @Target(ElementType.PARAMETER)
   @Retention(RetentionPolicy.RUNTIME) @interface GlobalWriteOnly{
      String value();
   }
